...
def GenerateTopasScripts(BaseDirectory, iteration, **vars):
    ...
    SimpleCollimator.append('s:Sc/PhaseSpaceFromColl/OutputFile                   = "' + str(Path(BaseDirectory) / "Results" / "coll_PhaseSpace") + "_itt" + str(iteration) + '"')
    ...
    SimpleCollimator.append('------------------------------------------------------------')
    SimpleCollimator.append('b:Gr/Enable = "True"  ')
    ...
    WaterTank.append('s:So/Example/PhaseSpaceFileName               = "' + str(Path(BaseDirectory) / "Results" / "coll_PhaseSpace") + "_itt" + str(iteration) + '"')
    ...
    WaterTank.append('s:Sc/PhantomScorer/OutputFile                   = "' + str(Path(BaseDirectory) / "Results" / "WaterTankOpt0_VarRed") + "_itt" + str(iteration) + '"')
    WaterTank.append('')
    WaterTank.append('')
