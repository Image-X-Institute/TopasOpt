def WriteTopasScript(**vars):
    ...
    SimpleCollimator.append('i:Ts/NumberOfThreads = 0  # defaults to 1')
    ...
    SimpleCollimator.append('d:Ge/World/HLX = 250 mm # Half Length')
    ...
    SimpleCollimator.append('sc:So/Beam/BeamPositionDistribution = "Gaussian" # None, Flat or Gaussian')
    SimpleCollimator.append('sc:So/Beam/BeamAngularDistribution  = "Gaussian" # None, Flat or Gaussian')
    ...
    SimpleCollimator.append('d:Ge/Target/HL  			= 1 mm')
    ...
    SimpleCollimator.append('s:Sc/PhaseSpaceFromColl/OutputType                  = "Binary" # ASCII, Binary, Limited or ROOT')
    SimpleCollimator.append('s:Sc/PhaseSpaceFromColl/OutputFile                  = "Results/coll_PhaseSpace_opt0_VarRed"')
    ...
    SimpleCollimator.append('------------------------------------------------------------')
    SimpleCollimator.append('b:Gr/Enable = "True"  # Enable/Disable graphics')
    ...
    WaterTank.append('------------------------------------------------------------')
    WaterTank.append('i:Ts/NumberOfThreads = 0  # defaults to 1')
    ...
    WaterTank.append('d:Ge/World/HLX = 250 mm # Half Length')
    ...
    WaterTank.append('s:So/Example/PhaseSpaceFileName              = "Results/coll_PhaseSpace_opt0_VarRed"')
    ...
    WaterTank.append('ic:Ge/Phantom/XBins = 150')
    WaterTank.append('ic:Ge/Phantom/YBins = 150')
    WaterTank.append('ic:Ge/Phantom/ZBins = 150')
    ...
    WaterTank.append('s:Sc/PhantomScorer/OutputType = "Binary" # "csv", "binary", "Root", "Xml" or "DICOM"')
    WaterTank.append('s:Sc/PhantomScorer/OutputFile                  = "Results/WaterTankOpt0_VarRed"')
    WaterTank.append('')
    WaterTank.append('')
    WaterTank.append('# Graphics View and trajectory filters:')
    WaterTank.append('------------------------------------------------------------')
    WaterTank.append('b:Gr/Enable = "False"  # Enable/Disable graphics')
