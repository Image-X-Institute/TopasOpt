...
def GenerateTopasScripts(BaseDirectory, iteration, **variable_dict):
    ...
    SimpleBeam.append('ic:So/Beam/NumberOfHistoriesInRun = 2000000')
    SimpleBeam.append('#ic:So/Beam/NumberOfHistoriesInRun = 8000000')
    SimpleBeam.append('')
    ...
    SimpleBeam.append('#d:Ph/Default/EMRangeMin = 10000. eV # minimum for EM tables')
    SimpleBeam.append('#d:Ph/Default/CutForElectron = 10 mm # overrides CutForAllParticles for Electron')
    SimpleBeam.append('b:Ph/ListProcesses = "False"')
    SimpleBeam.append('s:Ge/Phantom/AssignToRegionNamed = "Phantom"')
    SimpleBeam.append('d:Ph/Default/ForRegion/Phantom/CutForElectron = 2.5 mm')
    SimpleBeam.append('')
    SimpleBeam.append('# Variance reduction')
    SimpleBeam.append('------------------------------------------------------------')
    SimpleBeam.append('s:Ge/VrtParallelWorld/Parent = "World"')
    SimpleBeam.append('s:Ge/VrtParallelWorld/Type = "TsBox"')
    SimpleBeam.append('b:Ge/VrtParallelWorld/IsParallel = "True"')
    SimpleBeam.append('d:Ge/VrtParallelWorld/HLX = Ge/World/HLX cm')
    SimpleBeam.append('d:Ge/VrtParallelWorld/HLY = Ge/World/HLY cm')
    SimpleBeam.append('d:Ge/VrtParallelWorld/HLZ = Ge/World/HLZ cm')
    SimpleBeam.append('')
    SimpleBeam.append('b:Vr/UseVarianceReduction = "True"')
    SimpleBeam.append('')
    SimpleBeam.append('s:Ge/impCell1/Parent = "VrtParallelWorld"')
    SimpleBeam.append('s:Ge/impCell1/Type = "TsBox"')
    SimpleBeam.append('b:Ge/impCell1/IsParallel = "True"')
    SimpleBeam.append('d:Ge/impCell1/HLX = Ge/Phantom/HLX cm')
    SimpleBeam.append('d:Ge/impCell1/HLY = Ge/Phantom/HLY cm')
    SimpleBeam.append('d:Ge/impCell1/HLZ = Ge/Phantom/HLZ cm')
    SimpleBeam.append('d:Ge/impCell1/TransZ = Ge/Phantom/TransZ cm')
    SimpleBeam.append('')
    SimpleBeam.append('# Importance sampling')
    SimpleBeam.append('b:Vr/ImportanceSampling/Active         = "true"')
    SimpleBeam.append('sv:Vr/ImportanceSampling/ParticleName  = 2 "gamma" "e-"')
    SimpleBeam.append('s:Vr/ImportanceSampling/Component      = "VrtParallelWorld"')
    SimpleBeam.append('sv:Vr/ImportanceSampling/SubComponents = 1 "impCell1"')
    SimpleBeam.append('s:Vr/ImportanceSampling/Type = "ImportanceSampling"')
    SimpleBeam.append('uvc:Vr/ImportanceSampling/ImportanceValues = 1 10')
    SimpleBeam.append('')
    SimpleBeam.append('------------------------------------------------------------')
