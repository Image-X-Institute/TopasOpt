...
def GenerateTopasScripts(BaseDirectory, iteration, **variable_dict):
    ...
    SimpleBeam.append('ic:Ge/Phantom/XBins = 50')
    SimpleBeam.append('ic:Ge/Phantom/YBins = 50')
    SimpleBeam.append('ic:Ge/Phantom/ZBins = 60')
    ...
    SimpleBeam.append('------------------------------------------------------------')
    SimpleBeam.append('b:Gr/Enable = "True"  ')
